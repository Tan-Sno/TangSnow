...
[![Engine: GeckoView (MPL 2.0)](https://img.shields.io/badge/Engine-GeckoView%20%C2%B7%20MPL%202.0-orange.svg)](THIRD_PARTY_NOTICES.zh-CN.md)
...
完整说明见[隐私政策](docs/PRIVACY.md)与[用户协议](docs/TERMS.md)（均为中英同页对照）。
...
支持的版本范围与处理流程见 [SECURITY.zh-CN.md](SECURITY.zh-CN.md)。
...
[THIRD_PARTY_NOTICES.zh-CN.md](THIRD_PARTY_NOTICES.zh-CN.md)（其中包含 MPL 2.0 §3.2 要求的源码获取途径）。
